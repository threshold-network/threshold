---
description: The Basics of Staking Threshold (T) Tokens, and its benefits.
---
...
Since the beginning of 2026, T token holders have been able to [stake their T to receive fee rebates and waivers ](https://www.threshold.network/blog/tbtc-redemption-fee-waivers-for-t-stakers)when minting tBTC and redeeming BTC. With the reinstatement of minting fees, staking T has become even more valuable for reducing costs when using tBTC on the Threshold Bridge.
...
{% hint style="info" %}
Start Staking T and get tBTC fee waivers via  [https://app.threshold.network/stake](https://app.threshold.network/stake)
{% endhint %}
