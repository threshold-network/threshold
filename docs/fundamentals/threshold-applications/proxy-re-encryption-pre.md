...
{% content-ref url="../../guides/advanced-options/tbtc-v2-binary-installation/pre-node-setup.md" %}
[pre-node-setup.md](../../guides/advanced-options/tbtc-v2-binary-installation/pre-node-setup.md)
{% endcontent-ref %}
